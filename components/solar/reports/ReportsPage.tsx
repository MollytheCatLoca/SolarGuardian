...
import { dummySolarPark, dummyEnergyGeneration, dummyMaintenanceTasks } from '@/lib/solar/dummyData';
...
export default function ReportsPage() {
  ...
  const generateReport = () => {
    ...
    alert(`Generando informe de ${selectedReport} en formato ${selectedFormat} para el período ${format(dateRange.from, 'dd/MM/yyyy')} al ${format(dateRange.to, 'dd/MM/yyyy')}`);
  };
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-white mb-2">Informes y Análisis</h1>
            ...
            <div className="bg-[#111928] p-4 rounded-lg border border-[#374151]">
              <div className="flex justify-between items-start">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button variant="outline" size="sm" className="bg-[#111928] border-[#374151]  text-red-400 hover:text-red-300">
                    Eliminar
                  </Button>
                </div>
              </div>
